...
label.form-check-label {
    ...
    .form-check-input:checked + .form-check-label:before {
        background-color: #009649; /* Black background when checked */
    }
    ...
    <div class="form-check pd-left">
        ...
        <label class="form-check-label" for="fullTime">
            Full Time
                        ...
                        <div class="col-md-4">
                            <label for="inputJoinTime" >State</label>
                        ...
                        <div class="col-md-6">
                            <label for="inputExpectedSalary">Expected Salary :</label>
                            <input type="number" class="form-control" name="income" id="inputExpectedSalary">
                        </div>
                        <div class="col-md-6">
                            <label for="inputfileCv">Uplod CV :</label>
            ...
            <div class="col-sm-12 col-lg-5">
                <img src="<?=base_url("assets/img/join-us-rgt.webp"); ?>" class="img-fluid" alt="join-us">
            </div>
        </div>
