  <style>
    ...
    .home-ban-ul {
      ...
      padding: 0;
      margin: 0;
      animation: moveList 120s linear infinite;
        ...
        <div class="row gy-4">
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
              ...
              <h3><a href="<?= base_url('service#trucare'); ?>" class="stretched-link">TRUCARE</a></h3>
              ...
              <button class="open-btn" onclick="openPopup('assets/video/Truecare.mp4')">Watch Video</button>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card">
              ...
              <h3><a href="<?= base_url('service#truhaul'); ?>" class="stretched-link">TRUHAUL</a></h3>
              ...
              <button class="open-btn" onclick="openPopup('assets/video/TruHaul.mp4')">Watch Video</button>
            </div>
          </div><!-- End Card Item -->
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              ...
              <h3><a href="<?= base_url('service#oem'); ?>" class="stretched-link">TruAssure</a></h3>
          ...
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="card">
              ...
              <h3><a href="<?= base_url('service#trusense'); ?>" class="stretched-link">TRUSENSE</a></h3>
              <p class="home-service-txt">TruSense aims to enhance machine performance and utilisation through IoT based connectivity with an agile MES system for achieving best in class operational efficiency.</p>
            </div>
          </div>
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="section-header">
          ...
          <h2>DMMS <p class="text-center dms-head-p">Solution At Fingertips</p>
          </h2>
          <!-- <h5></h5> -->
