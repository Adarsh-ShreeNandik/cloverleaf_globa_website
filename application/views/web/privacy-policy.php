...
<head>
    ...
    <title>Privacy Policy for Cloverleaf CMMS </title>
...
<body>
    <div class="header">
        <div class="container">
            ...
            <p class="title">Privacy Policy for Cloverleaf CMMS</p>
        ...
        <div class="container">
            <div>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Application</strong> refers to Cloverleaf CMMS, the software program provided by the
                            Company.</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement) refers to CLOVERLEAF GLOBAL SOLUTIONS PRIVATE LIMITED, 202, 2nd Floor, Tower-C,
                            ITHUM, Plot No. A-40, Sector 62, Noida, Gautam Buddha Nagar, U.P. 201301.</p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By email: developer@cloverleafglobal.in</li>
                </ul>
